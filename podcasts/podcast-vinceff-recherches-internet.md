...
# Les risques de la publicité ciblée

Outre le risque de dé-confidentialisation des données que nous aurions souhaitées privée, la publicité ciblée peut comporter d'autres risques... Une analyse sous un angle Cyber est fourni dans ce lien, et discute du malvertising (malware + advertising) :
