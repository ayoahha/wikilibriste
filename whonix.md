...
- Sélectionnez une **VM**, en suivant notre tuto sur [**Virtualbox**](./virtualbox.md#.md#) vous pouvez modifier le cas échéant la quantité de mémoire que vous souhaitez allouer à vos **VM**.
